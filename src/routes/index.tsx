...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Apple Gift Card Offer — Claim Yours Today" },
      {
        name: "description",
        content:
          "Pick your device and follow three quick steps to claim your Apple gift card. Limited time offer.",
      },
      { property: "og:title", content: "Apple Gift Card Offer — Claim Yours Today" },
      {
...
const steps = [
  ...
  { title: "Get your Apple giftcard", desc: "Earn points and exclusive bonuses" },
];
        ...
        {device === null ? (
          ...
          <div className="text-center">
            ...
            <h1 className="mt-6 text-4xl font-extrabold leading-tight tracking-tight sm:text-[2.75rem]">
              ...
              <span className="text-primary text-glow">ApplePay</span>
            </h1>
            <p className="mt-3 text-sm text-muted-foreground">
            ...
            <a
              href="https://linkthem.net/aff_c?offer_id=2596&aff_id=27974"
